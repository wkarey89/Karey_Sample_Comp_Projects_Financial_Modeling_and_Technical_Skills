...
All models, tools, and frameworks in this portfolio are provided for educational and technical knowledge demonstration purposes only. They do not contain any proprietary or confidential data. If you are interested in learning more about how to create the right talent career framework, compensation philosophy or are interested in a career in compensation but don't know where to start, reach out to Karey.Wong@CompAI.com or Karey.Zyra@gmail.com. 

# 🧭 Job Architecture & Salary Structure Design 

1. 💼GTM Sales Job Architecture & Offer Guardrails- OTE, Pay Mix & Equity
This GTM sales compensation framework demonstrates how job architecture, role segmentation, and pay mix strategy are translated into standardized OTE ranges and equity bands to support consistent, market-aligned new-hire offer decisions. It defines career levels, job codes, and compensation grades across core GTM sales roles (SDRs, Account Executives, Territory Managers, and Sales Leadership) and is paired with a recruiter-facing offer calculator that dynamically surfaces OTE ranges, compa-ratios, equity guidelines, and total direct compensation visibility. The artifact highlights my ability to design scalable, governance-driven sales compensation frameworks that balance market competitiveness, internal equity, and operational usability, with all figures included for illustrative purposes only.

3. 🏗️ Global Job & Pay Architecture  
...
4. 📝 Job Evaluation & Leveling Framework  
...
5. ⚙️ Job Profile & Comp Grade Workday SOP  
...
6. 🛠️ Salary Structure Methodologies Overview
...
6. 📊 Annual Comp Timeline- Market Analysis, Budget Allocation, Salary Range Refresh   
...
8. 💻 External TDC Benchmarking Tool 


9. ⚖️Internal TDC Benchmarking Tool
...
10. 💰 Salary Increase Proposal Tool  
...
11. 📈 CEO Compensation Forecasting Tool
...
12. 🏢 Executive Comp Benchmarking Tool  
...
13. 📊 Total Rewards Statement Tool  
...
14. 📈 Total Rewards New Hire Offers Tool   
...
15. 📉 Total Rewards Severance Statement Tool  
...
16. ⚖️ Pay Equity Regression Analysis Tool 
...
17. 🧠 15 Long Term Incentive & 11 Short Term Design & Governance Matrix  
...
18. 🏗️ Enterprise Value-Based LTI Payout Modeling Tool  
...
19. 📊 LTIP Financial Metric Comparison Table (Aligned to 3-Statement Financial Model)  
...
20. 📉 3-Linked Financial Statement Model – EBITDA vs. EV Growth LTIP Calculations  
...
21. 🧮 KPIs & Incentive Payout Modeling Tool  
...
22. 🧠 Short- & Long-Term Incentive Funding & Payout Modeling Tool  
...
23. 🛠️ Annual Incentive Goverance and Adminsitration  
...
24. 📄 ISO and PSU LTI Proposal Template   
...
26. 📝 Compensation Operating Model & Workstream Blueprint
This blueprint provides a structured operating model for building and managing a modern compensation function, designed to help new compensation leaders quickly organize priorities, define ownership, and sequence workstreams across foundational design, annual programs, governance, and ongoing operations. It maps core compensation concepts—such as job architecture, pay architecture, market data, incentive programs, pay equity, and transparency—into a clear program framework with defined responsibilities, dependencies, and timing using RACI principles. The tool enables leaders to identify gaps in coverage, avoid duplication, and align cross-functional stakeholders while scaling compensation practices in a controlled, defensible way, and is intended as a reusable framework adaptable to any company stage or industry.

28. 🛡️ Oracle HRIS Implementation & Project Governance Strategy Deck  
...
29. 🛠️ Annual Compensation Planning in Workday – Admin Workflow Guide  
...
30. 🧩 Incentive Accrual & Proration Automation Logic in Workday  
...
31. 💻 VBA Stock Analysis Automation Tool  
...
A global compensation leader with 15+ years of experience educating businesses how to design, implement, and govern compensation programs to align with company's culture, performance and financial goals to stay market competitive, fair, and comply to evolving regulatory local laws. Her expertise spans across job architecture, cash and equity range incentive design, and advanced financial modeling and board presentation story telling skills. 

Known for her strength in Six Sigma project management, people science communications, human data governance, and change management, Karey brings a rare blend of analytical rigor, HR operational excellence, and trusted HR business partnership. She excels at leading high-impact initiatives from strategy through execution.
